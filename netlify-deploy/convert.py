...
with open('app-backup.jsx', 'r') as f:
    app_content = f.read()

# Remove imports
app_content = re.sub(r'^import.*?;$', '', app_content, flags=re.MULTILINE)
app_content = re.sub(r'^export default.*?;$', '', app_content, flags=re.MULTILINE)

# Replace environment variables with actual values
app_content = app_content.replace(
    'process.env.REACT_APP_SUPABASE_URL',
    "'https://ofqtgjzmbncmnkumybzb.supabase.co'"
)
app_content = app_content.replace(
    'process.env.REACT_APP_SUPABASE_ANON_KEY',
    "'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9mcXRnanptYm5jbW5rdW15YnpiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQ5NTMwNzYsImV4cCI6MjA3MDUyOTA3Nn0.35Aw-94WlR438UVT28qv54ppgvbgmlMgKfQ1Nj-t2F4'"
)
...
<body>
  ...
  <script type="text/babel">
    ...
    const Activity = () => <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M22 12h-4l-3 9L9 3l-3 9H2" /></svg>;
    ...
    const UserPlus = () => <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" /></svg>;
    const PhoneCall = () => <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>;
    const Target = () => <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2"/><circle cx="12" cy="12" r="6" stroke="currentColor" strokeWidth="2"/><circle cx="12" cy="12" r="2" stroke="currentColor" strokeWidth="2"/></svg>;
...
with open('index-complete.html', 'w') as f:
    f.write(html_template)

print("Created index-complete.html with full app functionality")